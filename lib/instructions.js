...
Instructions = function(instructionPath, versions, experimentCallback) {
    this.instructionPath = instructionPath; // Path to html page for instructions skeleton
    this.instructionSet = null;
    if (versions[0] < 7) {
        this.instructionSet = INSTRUCTION_ARRAY_NOVICE;
    }
    else {
        this.instructionSet = INSTRUCTION_ARRAY_EXPERT;
    }
