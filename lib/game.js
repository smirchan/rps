...
const BOT_STRATEGY_SET_SAME = server_constants.constants.BOT_STRATEGY_SET_SAME;
const BOT_STRATEGY_SET_RANDOM = server_constants.constants.BOT_STRATEGY_SET_RANDOM;
...
BotAgent = function(ability) {
    ...
    console.log(ability)
    console.log(this.fixed_strategy)
...
BotAgent.prototype.chooseMove = function(game) {
    ...
    if (game.current_round_index == 1 ||
        ...
        if (!prev_move || prev_move == "none" || !prev_outcome) {
            ...
            console.log(this.fixed_strategy_transitions[prev_outcome])
