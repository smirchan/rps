...
const INSTRUCTION_ARRAY = [
    ...
    {
        top_text: "<p>Rather than playing the game yourself, you're going to watch a set of AI agents play several rounds against an AI opponent.</p>",
        canvas_img: "",
        bottom_text: "<p>This opponent is a novice agent with a simple strategy. Its move choice each round will " + 
                     "depend on the previous round. Each agent may or may not learn the opponent's strategy over time.</p>"
    },
    {
        top_text: "<p>Your job is to assess the ability of these agents against the opponent. Click through each round, paying attention to how well " +
                  "the current agent is doing against the AI opponent.  Every 5 rounds, you will be asked to provide an estimate of how likely the agent is to win its next round.</p>",
        canvas_img: "",
        bottom_text: ""
    },
    {
