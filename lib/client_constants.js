...
const INSTRUCTION_ARRAY_NOVICE = [
    ...
    },
    {
        ...
        canvas_img: "",
        bottom_text: "<p>Opponent A is a novice agent with a simple strategy. Its move each round will " + 
                     "depend on the previous round. Each agent may or may not learn the opponent's strategy over time.</p>"
    },
    {
        top_text: "<p>Your job is to assess the ability of Agents 1, 2, and 3 against Opponent A. Click through each round, " +
...
INSTRUCTION_ARRAY_EXPERT[2]['bottom_text'] = "<p>Opponent A is an advanced agent with a complex strategy. Its move each round " +
