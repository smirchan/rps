...
highlight_opponent_move = function(opponent_move) {
    ...
    $("#opponent-move-rock").css({border: "5px solid white"});
    $("#opponent-move-paper").css({border: "5px solid white"});
    $("#opponent-move-scissors").css({border: "5px solid white"});
    $("#opponent-move-" + opponent_move).css({border: "5px solid #FFAAAA"});
};

highlight_agent_move = function(agent_move) {
    $(".agent-move-img").css({opacity: "1.0"});
    $("#agent-move-rock").css({border: "5px solid white"});
    $("#agent-move-paper").css({border: "5px solid white"});
    $("#agent-move-scissors").css({border: "5px solid white"});
    $("#agent-move-" + agent_move).css({border: "5px solid #008CBA"});
};
